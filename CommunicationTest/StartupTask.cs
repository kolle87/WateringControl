...
namespace BackgroundApplication3
{
    ...
    public sealed class TwiServer
    {
        ...
        // ----- ATmega Commands
        public void TWI_ATmega_ResetCounter() { var vARC = new byte[] { 0x22 }; TWI_VisibleLight.Write(vARC); }
        public byte TWI_ATmega_ReadSensor(byte vSensorNum) { var vASr = new byte[] { 0x21 }; var vASa = new byte[12]; TWI_VisibleLight.WriteRead(vASr, vASa); return vASa[vSensorNum]; }
        ...
        public byte TWI_Temperatur_TempH() { var vTHr = new byte[] { 0xAA }; var vTHa = new byte[2]; TWI_VisibleLight.WriteRead(vTHr, vTHa); return vTHa[0]; }
        public byte TWI_Temperatur_TempL() { var vTLr = new byte[] { 0xAA }; var vTLa = new byte[2]; TWI_VisibleLight.WriteRead(vTLr, vTLa); return vTLa[0]; }
